...
class InitWindow(QWidget):
    ...
    def get_accounts(self):
        ...
        self.switch_to_startup()
        return self.accounts

    def start_up(self):
        two_box = TwoBox(TWO_BOX_PATH)
        account_set = set(self.accounts.keys())

        while account_set:
            # Choose a random account from the set and remove it
